...
class OperacionesGastosUser(APIView):
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            return Response({'message':'Registro correcto de gasto'}, status=status.HTTP_201_CREATED)
    ...
    def put(self, request, idgasto,*args, **kwargs):
        try:
            ...
            gasto = serializer.save()
            return Response({'message':'Actualizacion correcta de gasto'}, status=status.HTTP_200_OK)
