...
class ResumenMovimientoMes(APIView):
    ...
    def get(self, request, anno, mes, *args, **kwargs):
        try:
            ...
            data={
                ...
                "ResumenConceptosGastos": resultado_gastos["ResumenConceptosGastos"] if resultado_gastos else [] ,
                "ResumenPorMediosDePagos": resultado_gastos["ResumenPorMediosDePagos"]if resultado_gastos else []
            }
